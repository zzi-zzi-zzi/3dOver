...
namespace RB3DOverlay.Overlay
{
    public static class OverlayManager
    {
        ...
        private static void RunRenderLoop(IntPtr window, int width, int height,
                                          CancellationToken ct)
        {
            using (var d3d = new Direct3D())
            {
                ...
                using (Device device = new Device(d3d, 0, DeviceType.Hardware, window,
        ...
        private static void SetupRenderStates(Device device)
        {
            ...
            device.SetTransform(TransformState.View, FF14CameraEx.View);
            device.SetTransform(TransformState.Projection, FF14CameraEx.Projection);
